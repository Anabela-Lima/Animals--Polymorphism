...
public class ZooTest {
    ...
    // Declaring the objects to be used in the tests
    ...
    @BeforeEach
    void setup(){
        // creating new objects - note these are not objects for abstract classes- you cannot create objects
    ...
    // Test to see that when ticket is sold, cash increases
